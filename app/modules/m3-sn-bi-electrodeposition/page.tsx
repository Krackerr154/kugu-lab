    ...
    <ModuleLayout module={module}>
      <section className="mt-4 rounded-xl border border-[var(--border)] bg-white p-5">
        ...
        <div className="mt-2 space-y-2 text-sm text-slate-600">
          <p><strong>Paduan vs logam murni:</strong> paduan Sn-Bi memiliki sifat fisis (titik leleh, kekerasan) yang berbeda dari komponen murninya.</p>
          <p><strong>Sel elektrokimia:</strong> anatomi — elektrolit, sumber DC, Anoda/Katoda, arah arus, elektroda inert dan kerja.</p>
          <p><strong>Elektrodeposisi:</strong> reduksi ion logam di katoda menggunakan arus listrik. Agen pengkompleks mengontrol laju dan komposisi deposit.</p>
          <p><strong>Hukum Faraday:</strong> massa teoretis = (I × t × M) / (n × F). Efisiensi arus = m_aktual / m_teoretis × 100%.</p>
        </div>
        <div className="mt-2"><SourceBadge pages="20-25" /></div>
      </section>
