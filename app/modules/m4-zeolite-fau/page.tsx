    ...
    <ModuleLayout module={module}>
      <section className="mt-4 rounded-xl border border-[var(--border)] bg-white p-5">
        ...
        <div className="mt-2 space-y-2 text-sm text-slate-600">
          <p><strong>Zeolit</strong> adalah aluminosilikat mikropori kristalin yang dibangun dari tetrahedra <ChemText>{"[SiO_{4}]^{4-}"}</ChemText> dan <ChemText>{"[AlO_{4}]^{5-}"}</ChemText> yang saling terhubung.</p>
          <p><strong>Aplikasi:</strong> adsorben, penukar ion, katalis (faujasite, fluid catalytic cracking).</p>
          <p><strong>Sintesis hidrotermal:</strong> nukleasi dan pertumbuhan kristal dalam larutan akuatik pada suhu/tekanan di atas ambien. Prekursor, suhu, dan waktu mempengaruhi struktur produk.</p>
          <p><strong>FAU (faujasite):</strong> zeolit X (Si/Al rendah) dan Y (Si/Al tinggi). Hubungan ke XRD (Modul 5) dan TGA (Modul 6).</p>
        </div>
        <div className="mt-2"><SourceBadge pages="26-28" /></div>
      </section>
