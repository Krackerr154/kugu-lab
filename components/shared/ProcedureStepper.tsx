          ...
          <li
            ...
            className={`rounded-lg border p-3 transition-colors ${
              completed.has(step.id)
                ...
                : "border-[var(--outline-variant)] bg-[var(--surface-muted)]"
            }`}
          >
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1">
                <div className="flex items-center gap-2 flex-wrap">
                  ...
                  {step.holdPoint && (
                    <span className="inline-flex items-center gap-1 rounded-full bg-[var(--danger-light)] px-2 py-1 text-xs font-medium text-[var(--danger)]">
                      <span aria-hidden="true" className="material-symbols-outlined text-sm">pause_circle</span> Hold Point
                    </span>
                  )}
                  {step.estimatedTime && (
                    <span className="inline-flex items-center gap-1 text-xs text-[var(--muted)]"><span aria-hidden="true" className="material-symbols-outlined text-sm">schedule</span> {step.estimatedTime}</span>
                  )}
                </div>
