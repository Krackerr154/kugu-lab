...
const PAGES_TO_TEST = [
  ...
  { name: "M2 Pre-lab Staged Journey", path: "/prelab/m2-mg2sno4" },
  { name: "M3 Pre-lab Staged Journey", path: "/prelab/m3-sn-bi-electrodeposition" },
  { name: "M2 Synthesis Module", path: "/modules/m2-mg2sno4" },
  { name: "M3 Electrodeposition Module", path: "/modules/m3-sn-bi-electrodeposition" },
